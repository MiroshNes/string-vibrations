...
def solver(I, V, f, a, U_0, U_L, L, dt, C, T, user_func = None):
    """
...
def animate(I, V, f, a, U_0, U_L, L, dt, C, T, umin, umax, anim = True):
   ...
   # user_func = plot_u if anim else None
...
def problem():
  ...
  #  u, x, t = animate(I, V, f, a, U_0, U_L, L, dt, C, T, umin, umax, anim=True)
